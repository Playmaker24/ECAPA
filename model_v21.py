...
class PreTDNN(nn.Module):
    def __init__(self, inplanes=1, planes=144):
        super(PreTDNN, self).__init__()

        self.conv1  = nn.Conv2d(1, 144, kernel_size=5, stride=1, padding=2)
        self.relu   = nn.ReLU()
        self.bn1    = nn.BatchNorm2d(planes)
        self.layer1 = Res2Net(144, 144, kernel_size=3, dilation=2, scale=6)
        self.layer2 = Res2Net(144, 144, kernel_size=3, dilation=3, scale=6)

        self.layer3 = nn.Conv2d(2*144, 32, kernel_size=1)
